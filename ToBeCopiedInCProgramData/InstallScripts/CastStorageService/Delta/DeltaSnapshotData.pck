...
<Package DatabaseKind="KB_CENTRAL" Description="Delta Snapshot Data" Display="Delta Snapshot Data" PackName="DELTA_SNAPSHOT_DATA" SupportedServer="ALL" Type="SPECIFIC" Version="1.0.0.1000">
	<Include>
